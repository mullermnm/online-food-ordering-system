...
<nav class="nav navbar">    
    ...
    <div class="chef-div col-md-6 col-sm-6"></div>
   <div class="start-div col-md-6 col-sm-6">
     
        <div>
            <h3>Welcome To Online Food Ordering System</h3>
            <a href="order.php"><button class="btn start-div-btn"><strong>Start Ordering</strong></button></a>
       </div>
   </div>
    <div class="addvertise-holder col-md-12 col-sm-12">
        <h3>Our Company Character</h3>
        <div class="speed col-md-3 col-sm-3">
            <h3>Speed</h3>
            <p>our product is very fast and simple that fits to anyone</p>
        </div>
        <div class="security col-md-3 col-sm-3">
            <h3>Security</h3>
            <p>our product is very secure that you can share any personal datas if you want</p>
        </div>
        <div class="reliable col-md-3 col-sm-3">
            <h3>Reliable</h3>
            <p>our product is reliable that has hardworking programmers, chefs and deliverers with it</p>
        </div>
    </div>
    <div class="phone-teller col-md-12 col-sm-12">
        <h3>Order a food paying with your phone</h3>
        <div class="order-ask col-md-7 col-sm-7">
            <h3>Order Food From Our Company</h3>
            <button class="start-div-btn">Order Now</button>
        </div>
        <div class="phone-svg col-md-5 col-sm-5">
